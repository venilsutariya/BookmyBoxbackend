...
import { editPartner, forgotPartnerPassword, getAllPartners, getPartner, logoutPartner, partnerLogin, partnerRegister, resetPartnerPassword, sendOtpToPartner } from "../controllers/partnerAuthenticationController";
